...
var Game = { 
    ...
    {        
        ...
        time = this.add.sprite(window.innerWidth-250, 50, 'time');
...
// 
        ...
        card_desc = this.add.sprite( window.innerWidth-247, window.innerHeight-121, 'card_desc');
...
// card position
    ...
    onDragStart: function(obj) {
        ...
        tween = Game.add.tween(obj.scale).to( { x: 1.2, y: 1.2 }, 100, Phaser.Easing.Linear.None, true);
    },
    ...
    onDragStop: function (obj) {
        ...
        tween = Game.add.tween(obj.scale).to( { x: 1, y: 1 }, 100, Phaser.Easing.Linear.None, true);
